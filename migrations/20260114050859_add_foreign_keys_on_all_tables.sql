...
ALTER TABLE tasks ADD CONSTRAINT fk_tasks_users FOREIGN KEY (user_id) REFERENCES users;
ALTER TABLE tasks ADD CONSTRAINT fk_tasks_equations FOREIGN KEY (equation_id) REFERENCES equations;
-- +goose StatementEnd